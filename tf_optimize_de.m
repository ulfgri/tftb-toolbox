function [Sopt] = tf_optimize_de(S,lambda,theta,pol,mfun,didx,mfpar,obj,mthresh,itmax,opt)
%function [Sopt] = tf_optimize_de(S,lambda,theta,pol,mfun,didx,mfpar,obj,mthresh,itmax,opt)
%
% tf_optimize_de :  Layer optimization with Differential Evolution 
%                   Adjusts thicknesses of a set of layers in 
%                   a thin film stack such that a merit function 
%                   matches a user-defined objective. The function
%                   uses a global differential evolution algorithm.
%                   This function can also be used to find good
%                   inital parameter guesses for further optimization
%                   with an algorithm that finds local minima.
%
% Input:
...
%
%          Type 'help devec3' for more information.
%
% Output:
