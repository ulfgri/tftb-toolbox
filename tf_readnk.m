...
%              in tabular form as a function of wavelength 
%              in micrometer
%
% Input:
...
%               the database root directory. The function
%               'tf_listnk' can be used to list available
%               material collections and the materials in them.
%
% Output:
